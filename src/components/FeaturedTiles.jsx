      ...
      <div className="mb-10 flex flex-col justify-between gap-5 md:flex-row md:items-end">
        <div>
          ...
          <p className="mt-3 max-w-2xl text-slate-600">
            These top picks are fetched from the tile data and selected for
            rooms that need texture, tone, and personality.
          </p>
        </div>
        <Link href="/all-tiles" className="btn border-[#4e6b52] text-[#4e6b52] hover:bg-[#4e6b52] hover:text-white">
          View All Tiles
        </Link>
      </div>
